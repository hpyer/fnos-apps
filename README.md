...
| 应用名称 | 版本号 | 应用介绍 | 下载 |
| --- | --- | --- | --- |
| [DSH for fnOS](apps/dsh/README.md) | `1.1.2` | 在飞牛 NAS 上为每位用户运行独立的 DeepSeek Harness 实例，支持目录授权、多版本管理、插件市场和自动空闲关闭。 | [GitHub](https://github.com/hpyer/fnos-apps/releases?q=DSH+for+fnOS&expanded=true) |
